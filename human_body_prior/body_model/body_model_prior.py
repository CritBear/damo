...
class BodyModel(nn.Module):
    ...
    def __init__(self,
        ...
        npose_params = smpl_dict['posedirs'][:, :, :69*3].shape[2] // 3
        if model_type:
        ...
        self.comp_register('J_regressor', torch.tensor(smpl_dict['J_regressor_prior'], dtype=dtype), persistent=persistant_buffer)

        # Pose blend shape basis: 6890 x 3 x 207, reshaped to 6890*30 x 207
        if use_posedirs:
            posedirs = smpl_dict['posedirs'][:, :, :69*3]
        ...
        weights = smpl_dict['weights_prior']
    ...
    def forward(self, root_orient=None, pose_body=None, pose_hand=None, pose_jaw=None, pose_eye=None, betas=None,
        ...
        verts, Jtr, v_shaped, J = lbs(betas=shape_components, pose=full_pose, v_template=v_template,
